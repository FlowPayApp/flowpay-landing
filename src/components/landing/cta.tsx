...
export function CtaBand() {
  return (
    <section id="demo" className="py-24 px-6 scroll-mt-24">
      <Reveal>
        <div className="max-w-4xl mx-auto bg-primary rounded-[2rem] p-12 text-center text-primary-foreground relative overflow-hidden ring-1 ring-primary-foreground/10">
          ...
          <div className="fp-cta-orb absolute top-0 right-0 size-64 bg-background/10 rounded-full -mr-20 -mt-20 blur-3xl" />
          <div
            className="fp-cta-orb absolute bottom-0 left-0 size-64 bg-background/10 rounded-full -ml-20 -mb-20 blur-3xl"
